                            ...
                            <ul className="flex items-center gap-8 lg:gap-8 xl:gap-12 text-[12px] lg:text-[12px] xl:text-[12px] lg:mr-[-20px]">
                                ...
                                <li className="py-2 relative">
                                    ...
                                    {showProductsDropdown && (
                                        <ul className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2">
                                            <li className="px-4 py-2 hover:bg-gray-100">
                                                <Link to="/granite-blocks">Granite Blocks</Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100">
                                                <Link to="/slabs">Slabs</Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100">
                                                <Link to="/monuments-sculptures">Monuments & Sculptures</Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100">
                                                <Link to="/counter-tops">Counter Tops</Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100">
